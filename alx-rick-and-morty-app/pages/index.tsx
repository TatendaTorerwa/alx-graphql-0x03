...
import ErrorProneComponent from "@/components/ErrorProneComponent"; // Import ErrorProneComponent
    ...
    <ErrorBoundary>
      <div className="min-h-screen flex flex-col bg-gradient-to-b from-[#A3D5E0] to-[#F4F4F4] text-gray-800">
        ...
        <main className="flex-grow p-6">
          <ErrorProneComponent /> {/* This component intentionally throws an error */}
